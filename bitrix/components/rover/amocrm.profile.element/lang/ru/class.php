...
$MESS['rover-acpe__field-sale_label']                       = 'Бюджет';
...
$MESS['rover-acpe__duplicates-add-complex-note']                            = ' (отключен. т.к. используется контроль дублей со стороны amoCRM)';
...
$MESS['rover-acpe__duplicate-control-help']     = 'Влючение этого функционала может замедлить отклик сайта в момент срабатывания события. Для ускорения отклика рекомендуется отложить <a target=\'_blank\' href=\'/bitrix/admin/settings.php?mid=rover.amocrm&lang=' . LANGUAGE_ID . '&tabControl_active_tab=agents\'>обработку новых событий на агента</a>. При этом агенты на сайте <u>обязательно</u> должны быть <a target="_blank" href="https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=2943">переведены на cron</a>.';
...
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_STATUS . '_label']  = 'Искать в этапах';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_STATUS . '_help']   = 'Ограничивает область поиска дубликатов сделками в указанных воронках и этапах.';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_NAME . '_label']     = 'Обновить название дубля';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_NAME . '_help']      = 'Работает, если выбрано действие «' . $MESS['rover-acpe__duplicate-action-' . Duplicate::ACTION__COMBINE . '_label'] . '»';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_STATUS . '_label']   = 'Обновить статус дубля';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_STATUS . '_help']    = 'Работает, если выбрано действие «' . $MESS['rover-acpe__duplicate-action-' . Duplicate::ACTION__COMBINE . '_label'] . '»';
$MESS['rover-acrm__duplicate-action-unsorted-help']                     = 'При создании сделки в «неразобранном» будут добавлены примечания со ссылками на дубликаты.';
...
$MESS['rover-acpe__field-' . Profile::UF_SITES_IDS . '_help']       = 'Если не выбран ни один сайт, профиль будет работать для всех';
$MESS['rover-acpe__field-' . Profile::UF_RESPONSIBLE_LIST . '_help']= '<ul><li>Пользователь будет назначен ответственным за создаваемые сделки, контакты и компании. Также ему будет ставиться создаваемая задача.</li><li>Если выбрано несколько пользователей, они будут назначаться по очереди.</li><li>Если сделка создается в «неразобранном», то ответственный назначается в Амо.</li></ul>';
...
$MESS['rover-acpe__field-' . Profile::UF_ADD_COMPLEX . '_help']     = '<ul><li>Необходима <a href="https://www.amocrm.ru/developers/content/crm_platform/duplication-control" target="_blank">дополнительная настройка для источника</a>.</li><li>Контроль дублей со стороны модуля <u>не осуществляется</u>.</li><li>Не работает, если сделка создается в «неразобранном».</li></ul>';
...
$MESS['rover-acpe__field-' . Profile::UF_BX_AMO_STATUSES . '_help']             = 'Синхронизируются согласно настройкам маппинга';
$MESS['rover-acpe__field-' . Profile::UF_BX_AMO_PRODUCTS . '_help']             = 'Товары будут переданы из заказа. Если в амо таких еще нет, то будут созданы новые.';
$MESS['rover-acpe__field-' . Profile::UF_AMO_BX_STATUSES . '_help']             = 'Синхронизируются согласно настройкам маппинга';
$MESS['rover-acpe__field-' . Profile::UF_AMO_BX_PRODUCTS . '_help']             = 'Синхронизация по количеству и наличию';
$MESS['rover-acpe__field-products_unsorted_help']                               = 'Не добавляются при создании сделки в «неразобранном»';
...
$MESS['rover-acpe__field-create-' . EntityTypesInterface::LEADS . '_help']  = 'Сделка будет привязана к контакту, в случае его создания.<br>При добавлении в «Неразобранное» сделка будет создаваться всегда, согласно своим настройкам.';
$MESS['rover-acpe__field-lead-name']                                        = 'Название';
...
$MESS['rover-acpe__header-' . EntityTypesInterface::TASKS . '-disabled']           = ' (отключена, т.к. сделка создаётся в «неразобранном»)';
$MESS['rover-acpe__field-create-' . EntityTypesInterface::TASKS]            = 'Создавать задачу';
$MESS['rover-acpe__field-create-' . EntityTypesInterface::TASKS . '_help']  = 'Если ни контакт, ни сделка, ни компания созданы не будут, задача так же не будет создана';
...
$MESS['rover-acpe__field-' . Profile::UF_TASK_DEADLINE . '_one-hour']       = 'Через час';
