...
$MESS['rover-acpe__title']                                                    = 'Editing an integration profile «#name#»';
...
$MESS['rover-acpe__field-sale_label']                                           = 'Budget';
...
$MESS['rover-acpe__duplicates-add-complex-note']                            = ' (disabled in case of amoCRM duplicate control)';
...
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_STATUS . '_label']  = 'Search in statuses';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_STATUS . '_help']   = 'Limits the scope of duplicate search by leads in selected statuses.';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_NAME . '_label']     = 'Update duplicate name';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_NAME . '_help']      = 'Works if action «' . $MESS[Duplicate::ACTION__COMBINE . '_label'] . '» is selected';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_STATUS . '_label']   = 'Update duplicate status';
$MESS['rover-acpe__duplicate-' . Profile::DUPLICATE_UPDATE_STATUS . '_help']    = 'Works if action «' . $MESS[Duplicate::ACTION__COMBINE . '_label'] . '» is selected';
$MESS['rover-acrm__duplicate-action-unsorted-help']                     = 'When creating a lead in «Unsorted», notes with links to duplicates will be added.';
...
$MESS['rover-acpe__field-' . Profile::UF_ADD_COMPLEX . '_help']     = 'Required <a href="https://www.amocrm.ru/developers/content/crm_platform/duplication-control" target="_blank">additional configuration for the source</a>.<br>Internal control of duplicates will be unavailable.';
...
$MESS['rover-acpe__field-' . Profile::UF_BX_AMO_STATUSES . '_help']             = 'Synchronized according to the mapping settings';
$MESS['rover-acpe__field-' . Profile::UF_BX_AMO_PRODUCTS . '_help']             = 'Products will be transferred from the order. If there are no such ones in AMO yet, then new ones will be created.';
$MESS['rover-acpe__field-' . Profile::UF_AMO_BX_STATUSES . '_help']             = 'Synchronized according to the mapping settings';
$MESS['rover-acpe__field-' . Profile::UF_AMO_BX_PRODUCTS . '_help']             = 'Synchronization by quantity and availability';
$MESS['rover-acpe__field-products_unsorted_help']                               = 'Not added when creating a lead in "unsorted"';
...
$MESS['rover-acpe__field-create-' . EntityTypesInterface::LEADS . '_help']  = 'The lead will be tied to the contact, if created.<br>When added to the "Unsorted", the lead will always be created, according to its settings.';
$MESS['rover-acpe__field-lead-name']                                        = 'Name';
...
$MESS['rover-acpe__header-' . EntityTypesInterface::TASKS . '-disabled'] = 'Task (disabled, because lead creates in "Unsorted" status")';
$MESS['rover-acpe__field-create-' . EntityTypesInterface::TASKS]            = 'Create task';
$MESS['rover-acpe__field-create-' . EntityTypesInterface::TASKS . '_help']  = 'A contact or lead must be linked to the task. If neither a contact nor a deal is created, the task will not be created either.';
...
$MESS['rover-acpe__field-' . Profile::UF_TASK_DEADLINE . '_one-hour']   = 'From one hour';
