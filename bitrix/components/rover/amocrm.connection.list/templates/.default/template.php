...
<div class="adm-toolbar-panel-container">
    ...
    <div class="adm-toolbar-panel-align-right">
        <a class="ui-btn ui-btn-light" href="/bitrix/admin/settings.php?lang=<?=LANGUAGE_ID?>&mid=rover.amocrm&mid_menu=1">
        ...
        <a class="ui-btn ui-btn-primary" href="/bitrix/admin/rover-acrm__connection-element.php?lang=<?=LANGUAGE_ID?>">
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'SHOW_ACTION_PANEL'     => false, // @TODO: true
