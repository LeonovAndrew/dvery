...
class MainApi
{
    ...
    public static function logout(Api $context, Main\Type\ParameterDictionary $params)
    {
        global $USER;
        ...
        return ['success' => !$USER->IsAuthorized()];
    }
    ...
    public static function registerApi(Api $api)
    {
        ...
        $api->registerApi('logout', array(__CLASS__, 'logout'));
