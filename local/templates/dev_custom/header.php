...
<!-- calltouch -->
<script>
(function(w,d,n,c){w.CalltouchDataObject=n;w[n]=function(){w[n]["callbacks"].push(arguments)};if(!w[n]["callbacks"]){w[n]["callbacks"]=[]}w[n]["loaded"]=false;if(typeof c!=="object"){c=[c]}w[n]["counters"]=c;for(var i=0;i<c.length;i+=1){p(c[i])}function p(cId){var a=d.getElementsByTagName("script")[0],s=d.createElement("script"),i=function(){a.parentNode.insertBefore(s,a)},m=typeof Array.prototype.find === 'function',n=m?"init-min.js":"init.js";s.async=true;s.src="https://mod.calltouch.ru/"+n+"?id="+cId;if(w.opera=="[object Opera]"){d.addEventListener("DOMContentLoaded",i,false)}else{i()}}})(window,document,"ct","k7nka0rk");
</script>
<!-- calltouch --> 
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-P25WQXS');</script>
...
<style>
	...
	header.clone .header__top a,header.clone .header__top .header-type-2 div{color:#000; }
	header.color-white.clone .catalog-menu>a,header.color-white.clone  .top-menu__item>a{color:#fff;}
...
.top-menu__sub{background:#fff; }
    
	.contact.bl span,.contact.bl a{color:#000;}
	.contact.bl .fa{color:#000; font-size:24px;}

	.sorting{padding:60px 0; }
	</style>
<script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src='https://vk.com/js/api/openapi.js?169',t.onload=function(){VK.Retargeting.Init("VK-RTRG-1452593-hQHMQ"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-1452593-hQHMQ" style="position:fixed; left:-999px;" alt=""/></noscript>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P25WQXS"
...
<!-- End Google Tag Manager (noscript) --> */ ?>
	...
	<?php   $APPLICATION->IncludeFile('/include/counter.php'); ?>
...
<a href="mailto:production@dveri-provance.ru" class="menu__mail">production@dveri-provance.ru</a>
	...
	<header itemscope itemtype="https://schema.org/Organization" class="<?if($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())):?>header-type-2<?else:?>color-white<?endif;?>">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="header">
							...
							<div class="header__left">
								<a href="/" class="header__logo">
									<?if($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())):?>
										<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-black.png" alt="page-logo-black" itemprop="logo">
									<? else :?>
										<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-white.png" alt="page-logo-white" itemprop="logo">
									<? endif; ?>
								</a>
...
<li class="top-menu__sub-item"><a href=" https://dveri-provance.ru/stroy_paneli/">Стеновые панели</a></li> 
    <li class="top-menu__sub-item"><a href=" https://dveri-provance.ru/peregorodki/">Межкомнатные перегородки</a></li> 
							...
							<div class="header__right">
								...
								<?$APPLICATION->IncludeComponent("bitrix:menu", "top_lvl", Array(
						...
						<div class="header__bottom">
							...
							<div class="header__popups">
								<div class="header__call" type="button" data-popup-selector="callback">
									Заказать звонок
								</div>
								<? if ($CONTACTS['PROPERTIES']['PHONE']['VALUE']) :?>
									<a href="tel:<?=$CONTACTS['PROPERTIES']['PHONE']['VALUE']?>" class="header__phone" itemprop="telephone">
					...
					<div class="header__bottom__address">Москва, Рублевское шоссе 14, корп. 1 <a href="/contacts/"itemprop="address">все салоны</a></div>
