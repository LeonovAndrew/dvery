...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
	...
	j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
	'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
	})(window,document,'script','dataLayer','GTM-5KJ3W79');</script>
<!-- End Google Tag Manager -->
...
<script type="bogus" class="js-whatsapp-message-container">Здравствуйте: {roistat_visit}</script>					
<script>					
(function() {					
...
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5KJ3W79"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
							...
							<div class="header__left">
								<a href="/" class="header__logo">
									<?if($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())):?>
										<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-black.png" alt="page-logo-black">
									<? else :?>
										<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-white.png" alt="page-logo-white">
									<? endif; ?>
								</a>
    ...
    <li class="top-menu__sub-item"><a href=" https://dveri-provance.ru/peregorodki/">Межкомнатные перегородки</a></li> 
						...
						<div class="header__bottom">
							...
							<div class="header__popups">
								<div class="header__call" data-popup-selector="callback" onclick="ym(64922065,'reachGoal','zakazzvonklik')">
									Заказать звонок
								</div>
								<? if ($CONTACTS['PROPERTIES']['PHONE']['VALUE']) :?>
									<a href="tel:<?=$CONTACTS['PROPERTIES']['PHONE']['VALUE']?>" class="header__phone">
