    ...
    "use strict";
        ...
        $.extend(sergelandimagezoomer, {
            ...
            controlLoop: function ($tracker) {
                ...
                var $defImg = $('.magnifier img:last-child');

                // custom add new img
                if($('.magnifier .loupe2').length){
                    $('.magnifier .loupe2').css({'width': $defImg.css('width'), 'height': $defImg.css('height'), 'left': $defImg.css('left'), 'top': $defImg.css('top')});
                }
            },
            ...
            init: function ($img, options, gallery) {
               ...
               $img.mouseover(function(e){				
                    var o = $img.offsetsl();
                    $('.magnifier .loupe2').css({left: "100px", top: o.top});
               ...
               $tracker.mouseover(function(e){
                    ...
                    $('[data-fancybox]').removeClass('active-loup');
                    $img.parent('[data-fancybox]').addClass('active-loup');
                ...
                $tracker.one("mouseover", function(e){	
                    ...
                    // custom add new img
                    if($('.js-loupe2').length){
                        var $bigimage2 = $('<img class="loupe2" src="' + $('.js-loupe2').data('large') + '"/>').css({position:"absolute", top: "0", left:"0", maxWidth:"none"}).appendTo($magnifier);
                    }
                    // end custom add new img
