    ...
    <div class="cont">
        ...
        <div class="news__cont article__slide">
        	<? foreach($arResult['ITEMS'] as $arItem) :
        		$img = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE']['ID'], array('height' => 393, 'width' => 364 ), BX_RESIZE_IMAGE_EXACT, false, false, false, 70);
	            ...
	            <div class="news__item-help">
	                <div class="news__item">
	                    <div class="news__img useful-know" style="background-image:url(<?=$arItem['PREVIEW_PICTURE']['SRC']?>)"></div>
