...
<?if($USER->IsAdmin())
{?>
	<div data-id="<?=$item['ID']?>" class="fav_star">
		<div class="fav_action"><a class="fav_link" href="/favorites/">Перейти в избранное</a><a href="" class="fav_delete">Удалить из избранного</a></div>
	</div>
<?}?>

<?
	$img = CFile::ResizeImageGet($item['PREVIEW_PICTURE']['ID'], array('height' => 360, 'width' => 151 ), BX_RESIZE_IMAGE_PROPORTIONAL, false, false, false, 70);
