...
.header-type-2 .top-menu__sub {
	...
	body .header-type-2 .top-menu__sub-item a{color:#000; }
					...
					<div class="header__left">
						<a href="/" class="header__logo">
							<?if($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())):?>
								<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-black.png" width="162" height="49" alt="page-logo-black">
							<? else :?>
								<img class="header-logo" src="<?=SITE_TEMPLATE_PATH?>/img/page-logo-white.png" width="162" height="49" alt="page-logo-white">
							<? endif; ?>
						</a>
    ...
    <li class="top-menu__sub-item"><a href=" https://dveri-provance.ru/peregorodki/">Межкомнатные перегородки</a></li> 
				...
				<div class="header__bottom">
					...
					<div class="header__popups">
						<div class="header__call text-type-4  text-bold" data-popup-selector="callback">
							Заказать звонок
						</div>
						<? if ($CONTACTS['PROPERTIES']['PHONE']['VALUE']) :?>
							<a href="tel:<?=$CONTACTS['PROPERTIES']['PHONE']['VALUE']?>" class="header__phone text-type-4 text-bold">
