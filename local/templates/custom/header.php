...
<head> 
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-P25WQXS');
	</script>
...
<!-- Google Tag Manager (noscript) -->
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P25WQXS" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
...
<? endif; */ ?>
	...
	<header itemscope itemtype="https://schema.org/Organization" class="<? if ($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())) : ?>header-type-2<? else : ?>color-white<? endif; ?>">
		<div class="cont">
			<div class="header">
					...
					<div class="header__left">
						<a href="/" class="header__logo">
							<? if ($APPLICATION->GetCurDir() != '/' && !preg_match("/\/news\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/articles\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) && !preg_match("/\/catalog\/([-_a-zA-Z0-9]+)\/([-_a-zA-Z0-9]+)/", $APPLICATION->GetCurDir()) ||  preg_match("/\/catalog\/sistemy\/([a-zA-Z0-9]+)/", $APPLICATION->GetCurDir())) : ?>
								<img class="header-logo" src="<?= SITE_TEMPLATE_PATH ?>/img/page-logo-black.png" width="162" height="49" alt="page-logo-black" itemprop="logo">
							<? else : ?>
								<img class="header-logo" src="<?= SITE_TEMPLATE_PATH ?>/img/page-logo-white.png" width="162" height="49" alt="page-logo-white" itemprop="logo">
							<? endif; ?>
						</a>
				...
				<div class="header__bottom">
					...
					<div class="header__popups">
						...
						<? if ($CONTACTS['PROPERTIES']['PHONE']['VALUE']) : ?>
							<a href="tel:<?= $CONTACTS['PROPERTIES']['PHONE']['VALUE'] ?>" class="header__phone text-type-4 text-bold" itemprop="telephone">
			...
			<div itemprop="address" class="header__bottom__address">Москва, Рублевское шоссе 14, корп. 1 <a href="/contacts/">все салоны</a></div>
