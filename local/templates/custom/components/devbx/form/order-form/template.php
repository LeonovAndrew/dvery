...
?>
<form action="<?=POST_FORM_ACTION_URI?>" onsubmit="ym(64922065,'reachGoal','send_all_forms'); var _tmr = window._tmr || (window._tmr = []); _tmr.push({ type: 'reachGoal', id: 3339490, goal: 'send_form'}); console.log('form order-form');" method="post" enctype="multipart/form-data" class="popup__cont">
    ...
    <?else:?>
        <div class="popup__list">
            ...
            <input type="text" name="UF_EMAIL" autocomplete="off" placeholder="E-mail (не обязательно)" class="popup__list-item" value="<?=$arResult['FIELDS']['UF_EMAIL']['VALUE']?>">
