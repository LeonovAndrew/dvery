...
?>
<form action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data" onsubmit="ym(64922065,'reachGoal','send_all_forms'); var _tmr = window._tmr || (window._tmr = []); _tmr.push({ type: 'reachGoal', id: 3339490, goal: 'send_form'}); console.log('form jobresponse');">
    ...
    <?if ($arResult['SUCCESS']):?>
        ...
        <div class="alert alert-success">Ваша отклик отправлена</div>
        </p>
    <?else:?>
