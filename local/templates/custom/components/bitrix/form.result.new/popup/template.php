...
<div class="popup__cont js-form-ajax <?=$arResult["arForm"]["SID"]?>">
    ...
    <div class="popup__title">
		...
		<?}else{?>
			...
			<?=$arResult["FORM_HEADER"]?>
			    ...
			    <button type="submit" value="<?=$arResult["arForm"]["BUTTON"]?>" class="popup__btn" name="web_form_submit">Заказать обратный звонок</button>
