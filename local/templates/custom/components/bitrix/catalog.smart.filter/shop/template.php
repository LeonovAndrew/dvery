...
?>
<aside class="bx_filter <?=$templateData["TEMPLATE_CLASS"]?>">
	<button class="open_filter">Фильтр</button>
	<div class="filter"> <?/*<div class="bx_filter_section">*/?>
			...
			<?
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="item active  bx_filter_parameters_box">
							...
							<div class="data" style="display: block;">
								<div class="range price_range">
									...
									<div class="flex">
										<input type="text" placeholder="<?echo $arItem["VALUES"]["MIN"]["VALUE"]?>" class="input_range ot"
										...
										>
										<div class="step"></div>
										<input type="text" placeholder="<?echo $arItem["VALUES"]["MAX"]["VALUE"]?>" class="input_range do" 
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="item bx_filter_parameters_box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
						<span class="bx_filter_container_modef"></span>
						<div class="open_btn"><?=$arItem["NAME"]?></div>
						<div class="data" <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>style="display:block"<?endif?>>
								...
								default://CHECKBOXES
									...
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										...
										<div class="checkbox_text">
											<label class="label_check  <? echo $ar["DISABLED"] ? 'disabled': '' ?>" data-role="label_<?=$ar["CONTROL_ID"]?>" for="<? echo $ar["CONTROL_ID"] ?>">
												<input type="checkbox" 
													value="<? echo $ar["HTML_VALUE"] ?>"
													name="<? echo $ar["CONTROL_NAME"] ?>"
													id="<? echo $ar["CONTROL_ID"] ?>"
												...
												<span class="check_text"><?=$ar["VALUE"];?>
												<?if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
													?> (<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
												endif;?></span>
											</label>
			...
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						...
						<input class=" reset_btn" type="submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
						<input class="reset_btn" type="submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" />

						<div class="bx_filter_popup_result right" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])){ echo 'style="display:none"'; }else{?> style="display: inline-block;"<?}?>>
