        ...
        <div class="card__cont">
            <div class="card__side js-card-side">
                ...
                <div class="card__main-text card__main-text-mobile" style="font-size:14px">
                	На странице представлены самые популярные модели двери. Вы можете <a href="<?=CFile::GetPath($arResult['PROPERTIES']['CATALOG2']['VALUE'])?>">скачать полный каталог</a> или заказать свой рисунок, <a href=""  data-popup-selector="callback">заполнив форму</a>
                </div>
