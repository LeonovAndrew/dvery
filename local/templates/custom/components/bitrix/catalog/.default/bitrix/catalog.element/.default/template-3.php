...
<!-- there -->
                            ...
                            foreach ($arResult['OFFERS'] as $k=>$offer){
                                ...
                                ?>
                                	<div class="card__result-pic">
		                                ...
		                                <?php endif; ?>
                                        <!--<div class="card__result-pic-ext">
                                            <img class="js-loupe" src="/bitrix/images/1.gif" alt="<?php /*= $arResult['NAME'] */?>" data-result-id="<?php /*= $offer['ID'] */?>" data-large="">
                                        </div>-->
                                    </div>
				...
				<svg xmlns="http://www.w3.org/2000/svg" class="icon sprite-main-icons base-button__icon base-button__icon--right"><use href="/upload/ic-btn.svg#i-configure" xlink:href="/upload/ic-btn.svg#i-configure"></use></svg> <!----></span> <!----></button>
...
<center class="new">
  <div id="button" align="center">
    <a href="tel:+7(495)154-30-83" class="popup__btn_catalog_call">Задать вопрос по телефону</a>
  </div>
  <script>
    //код виджета
  </script>
