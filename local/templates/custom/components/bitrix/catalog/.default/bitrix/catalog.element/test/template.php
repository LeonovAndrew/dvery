			...
			<div class="card__side js-card-side">
				...
				<div class="card__info">
					...
					<div class="card__price">
                        ...
                        $old_price = $price + $price*$old_price_coef/100;
                        ?>
                        <div class="card__price_old"><span><?= number_format($old_price, 0, '', ' ') ?></span> ₽</div>
						<div class="card__price_act">от <span><?= number_format($price, 0, '', ' ') ?></span> ₽</div>
                        <div class="card__price_parts">Частями по <span><?=number_format(round($price/6,0), 0, '', ' ')?></span> руб в мес.</div>
					</div>
						...
						<div class="card__popup" id="card__kit_popup">
							<div class="card__popup_window">
								...
								<div class="card__popup_body">
									<ol>
										<li>В комплект входит Полотно стандартное 600х2000 мм</li>
										<li>Коробка стандартная</li>
										<li>Наличник 5 штук (2000  мм)</li>
									</ol>
								</div>
							</div>
						</div>
					...
					<div class="card__meta">
						...
						<? if (!empty($arResult['OFFERS'])) : ?>
                            ...
                            <div class="card__meta_model">Модель: <span><?= $arResult['CURRENT_OFFER']['DETAIL_TEXT'] ?></span></div>

                            <?if($arResult['CURRENT_OFFER']['COVER']):?>
