    ...
    <div class="cont">
        ...
        <div class="news__cont article__slide">
            <? foreach ($arResult['ITEMS'] as $arItem) :
                $img = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE']['ID'], ['height' => 393, 'width' => 364], BX_RESIZE_IMAGE_EXACT, false, false, false, 70);
                ...
                <div class="news__item-help">
                    <div class="news__item">
                        <div class="news__img useful-know"
                             style="background-image:url(<?= $arItem['PREVIEW_PICTURE']['SRC'] ?>)"></div>
                        <? /*<div class="news__img useful-know" data-src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>"></div>*/
                        ?>
                            ...
                            <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="news__link">
                                ...
                                <div class="news__link-img">
                                    <svg width="17" height="10" viewBox="0 0 17 10" fill="none"
                                        ...
                                        <path d="M15.1338 5.00015L11.0594 0.925781M15.1338 5.00015L11.0594 9.07451M15.1338 5.00015H0.000432611"
