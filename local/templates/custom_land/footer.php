...
?>
	...
	if ($APPLICATION->GetCurDir() == '/') { ?>
		<div class="repometr-widget-container" style="height: 100%; width: 100%; position: relative; overflow: hidden;">
			...
			<script type="text/javascript" src="https://en.repometr.com/jsi18n/"></script>
			<script type="text/javascript" src="https://alfatest.repometr.com/jsi18n/"></script>
	...
	<div class="popup" data-popup="callback">
		<form class="popup__cont js-form-ajax">
			...
			<button type="submit" class="form_callback popup__btn">Заказать обратный звонок</button>
			<p class="form__message"></p>
		</form>
	</div>
