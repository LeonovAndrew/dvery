...
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/catalog.css");
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/catalog_media.css");
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/jquery.fancybox.css");
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/ion.rangeSlider.css");
	...
	<div class="cont">
		...
		<?
			$arFilterParams = array(
				"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
				"SECTION_ID" => !empty($arResult['VARIABLES']['SECTION_CODE']) ? $arCurSection['ID'] : 0,
			...
			<?include('sort.php')?>
				...
				$intSectionID = $APPLICATION->IncludeComponent(
					...
					array(
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
						"ELEMENT_SORT_FIELD" => $arAvailableSort[$_SESSION['SORT']][1], //$arParams["ELEMENT_SORT_FIELD"],
						"ELEMENT_SORT_ORDER" => $_SESSION['SORT_BY'], //$arParams["ELEMENT_SORT_ORDER"],
