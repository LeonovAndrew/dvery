...
if (!empty($arResult["SECTIONS"])) {
	$elements = [];
	$rsElements = CIBlockElement::GetList(array("SORT" => "asc", "ID" => "desc"), ["IBLOCK_ID" => $arParams["IBLOCK_ID"], "IBLOCK_SECTION_ID" => array_keys($arResult['SECTIONS']), 'ACTIVE' => 'Y'], false, false, ['NAME', 'CODE', 'IBLOCK_SECTION_ID']);
	while($arElement = $rsElements->fetch()) {
		$arResult["ELEMENT_LINKS"][$arElement["IBLOCK_SECTION_ID"]][] = $arElement;
	}
}
