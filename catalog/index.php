...
$APPLICATION->SetPageProperty("description", "Каталог межкомнатных дверей в различных стилях от Фабрики PROVANCE. Каталог межкомнатных дверей с ценами и моделями.");
$APPLICATION->SetPageProperty("keywords", "Межкомнатные двери список каталог стили цены виды");
$APPLICATION->SetPageProperty("title", "Каталог межкомнатных дверей");
$APPLICATION->SetTitle("Каталог межкомнатных дверей");


if (isset($_GET['material']) && intval($_GET['material']) > 0) {
	global $arrProducts;
	$arrProducts['OFFERS']['PROPERTY_MATERIAL'] = intval($_GET['material']);
}
