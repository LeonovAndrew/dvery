...
$APPLICATION->SetPageProperty("description", "Межкомнатные двери Прованс. Изготовление дверей высокого качества, по европейским технологиям");
$APPLICATION->SetPageProperty("keywords", "Межкомнатные двери Прованс, производство дверей, двери на заказ");
								...
								?>
									<div class="sorting-select-option sorting-select-option-img select-option js-filter-color-parent" data-material="<?=$color['IBLOCK_SECTION_ID']?>">
										...
										<label for="colors<?=$key?>" class="sorting-select-option-text text-type-1">
											<span class="sort-img">
												<img src="<?=CFile::GetPath($color['DETAIL_PICTURE'])?>" alt="">
											</span>
...
<? if (isset($MAIN_BANNERS[2])) :?>
	<div class="banner-type-1" style="background-image: url(<?=CFile::GetPath($MAIN_BANNERS[2]['DETAIL_PICTURE'])?>);">
		<div class="banner__bg">
			<div class="banner__title">
				<?=$MAIN_BANNERS[2]['NAME']?>
			</div>
