...
$APPLICATION->SetTitle("ЦДиИ \"Экспострой на Нахимовском\" №2");
?><style>
...
<div class="contacts-list__block">
	<div class="contacts-list__block-text">
		 Москва, Нахимовский проспект, 24, павильон 3, 1 этаж, блок 7с, стенд 82<br>
		 E-mail: <a href="mailto:82expo@dveri-provance.ru">82expo@dveri-provance.ru </a>
	</div>
	<div class="contacts-list__block-time">
		 Время работы: с 10 до 20 (пн-сб)<br>
		 с 10 до 19 (вс)
	</div>
...
<div class="tour">
	<h2>3D-тур по салону</h2>
	 <iframe src="https://foto-g.org/3d/doors/5expo82/5expo82.html"></iframe>
</div>
 <?
$GLOBALS['arrFilter'] = array('=PROPERTY_SALON'=>381);
