...
$APPLICATION->SetTitle("ТК \"Каширский двор - 1\" №1");
?><style>
...
<div class="contacts-list__block">
	<div class="contacts-list__block-text">
		 ТК «КАШИРСКИЙ ДВОР», г. Москва, Каширское шоссе, д. 19, корп. 1,&nbsp;4 этаж, пав. 4В-74<br>
		 E-mail: <a href="mailto:tkkd@dveri-provance.ru">tkkd@dveri-provance.ru</a>&nbsp;(пав. 4В-74)<br>
	</div>
	<div class="contacts-list__block-time">
		 Время работы: с 10 до 20 (пн-вс)
	</div>
...
<div class="how-go">
	<div class="map">
		<h2>На карте</h2>
		 <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Aae5998b41dd707487ff82490ad44e9f227201b8709771e9475c58415acd5dfbf&amp;source=constructor" width="500" height="400" frameborder="0"></iframe>
	</div>
	<div class="sheme">
		<h2>Схема проезда</h2>
...
<div class="how-go" style="margin-bottom:40px; margin-top:40px;">
	<div class="sheme">
		<h2>Как пройти</h2>
 <img src="/contacts/sheme/kash.png">
	</div>
</div>
<div class="tour">
 ...
 <?
$GLOBALS['arrFilter'] = array('=PROPERTY_SALON'=>379);
