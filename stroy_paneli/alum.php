...
$APPLICATION->SetPageProperty("title", "Стеновые панели на алюминиевом профиле: цены и варианты расцветок");
            ...
            <div class="container">
              <div class="block_1_bot_slider_inner_in_txt">
                <div class="block_1_bot_slider_inner_in_txt_in">
                  <h1>Стеновые панели на алюминиевом профиле</h1>
    ...
    <div class="container">
      <div class="block_2_card_in">
        ...
        $shpon_all_arr = array(
          ...
          "Шпон cotton-white",
          "Шпон винтаж",
          "Шпон дуб-натуральный̆",
          "Шпон карамель",
          "Шпон bourbon",
          "Шпон mud-light",        
          "Шпон перец",
          "Шпон гречка",        
          "Шпон орех-натуральный̆",
          "Шпон asg-grey",
          "Шпон черный ясень",
          "Шпон черный перец"
      );
      $shpon_icon_arr = array(
        "Белый ясень",
        "Декапе",
        "Smoke",
        "Natural",   
          ...
          <div class="block_2_card_flex_img">
            ...
            <?php $i=0; foreach($shpon_arr as $key=>$img){ ?>
                <div class="block_2_card_flex_img_in" id="img_show<?=$i?>" <?php if($i==0){ ?>  style="display: block;" <?php } ?>>
                  <img src="https://dveri-provance.ru/stroy_paneli/img/shpon/<?=$key?>" alt="<?= htmlspecialcharsbx($shpon_all_arr[$i]) ?>">
                </div>    
            <?php $i++; } ?>
            ...
            <div class="block_2_card_flex_txt_in2">
              ...
              <div class="block_2_card_flex_txt_in2_in">
                ...
                <div class="type_chose tooltip  <?php if($i==0){ ?> type_chose_act <?php } ?>" title="<?=$img?>" data-id="<?=$i?>">
                  <img src="https://dveri-provance.ru/stroy_paneli/img/shpon/icon/<?=$key?>" alt="<?= htmlspecialcharsbx($shpon_icon_arr[$i]) ?>" style="border:1px solid #eee;">
                </div>
                <?php $i++;  } ?>
...
<div class="block_2_card_flex">
          <div class="block_2_card_flex_img">
            ...
            <?php $i=0; foreach($emal_arr as $key=>$img){ ?>
                <div class="block_2_card_flex_img_in" id="img_show<?=$i?>" <?php if($i==0){ ?>  style="display: block;" <?php } ?>>
                  <img src="https://dveri-provance.ru/stroy_paneli/img/emal/<?=$key?>" alt="<?= htmlspecialcharsbx($alt_arr[$i]) ?>">
                </div>    
            <?php $i++; } ?>
           ...
           <!-- <div class="block_2_card_flex_txt_in1">
            ...
            <div class="block_2_card_flex_txt_in2">
              ...
              <div class="block_2_card_flex_txt_in2_in">
                ...
                <?php $i=0; foreach($emal_arr as $key=>$img){ ?>  
                <div class="type_chose tooltip  <?php if($i==0){ ?> type_chose_act <?php } ?>" title="<?=$img?>" data-id="<?=$i?>">
                  <img src="https://dveri-provance.ru/stroy_paneli/img/emal/icon/<?=$key?>" alt="<?= htmlspecialcharsbx($img) ?>" style="border:1px solid #eee;">
                </div>
                <?php  $i++; } ?>
